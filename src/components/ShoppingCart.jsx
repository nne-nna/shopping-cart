...
const ShoppingCart = () => {
  ...
  return (
    <>
        <div className={`w-[300px] h-screen bg-gray-200 fixed top-0 z-30 border-l-4 border-red-200 rounded-tl-lg ${
        ...
        >
            ...
            <div className='w-full h-20 bg-white absolute bottom-0 left-0 z-10 grid place-items-center border rounded-lg'>
                <h1 className='text-xl text-gray-600'>Total: {totalPrice}</h1>
