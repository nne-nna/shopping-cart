...
const ShoppingCart = () => {
  ...
  return (
    ...
    {cartItems.length !== 0 && (
            ...
            >
            <div 
                className='w-full h-16 bg-white absolute left-0 top-0 z-10 grid place-items-center border rounded-lg'>
            ...
            <div 
                className='h-screen flex flex-col gap-y-3 overflow-y-scroll px-5 pb-24 pt-20'
            >
                {cartItems?.map((item) => {
            ...
            <div 
                className='w-full h-20 bg-white absolute bottom-0 left-0 z-10 grid place-items-center border rounded-lg'
            >
